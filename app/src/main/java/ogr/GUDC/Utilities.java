...
public class Utilities {
    ...
    public class CustomDialog extends Dialog {
        ...
        public CustomDialog(Context context, View view) {
            ...
            setContentView(view);
            getWindow().getDecorView().setBackgroundColor(context.getResources().getColor(R.color.main_background));
...
//            getWindow().getDecorView().setBackgroundDrawable(drawable);
    ...
    public static void InputDialog(Context context, final String msg, final Runnable okRunnable,
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String response) {
                try {
                    ...
                    TextView text = (TextView) dialog.findViewById(R.id.dialogtext);
                    text.setText(msg);
                    Button yesButton = (Button) dialog.findViewById(R.id.dialogButtonOK);
     ...
     * @param noRunnable  optional {@link Runnable} to trigger after no was pressed.
     */
    public static void customYesNoMessageDialog(final Context context, final String msg,
                                                final String yesText, final Runnable yesRunnable,
                                                final String noText, final Runnable noRunnable) {
        new AsyncTask<String, Void, String>() {
            protected String doInBackground(String... params) {
                return ""; //$NON-NLS-1$
            }
